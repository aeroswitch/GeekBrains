...
a = int(input('Введите кол-во километров, которое спорстмен пробежал в первый день: '))
b = int(input('Введите кол-во километров, которое нужно достигнуть: '))
day_num = 1

while a < b:
    a = a + a * 0.1
    day_num += 1
print(f'Номер дня, когда спортсмен достигнет результата: {day_num}')
